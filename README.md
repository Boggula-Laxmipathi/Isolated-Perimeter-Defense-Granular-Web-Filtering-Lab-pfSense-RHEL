...
# Verify static IP and gateway assignment
...
curl -I [https://www.incometax.gov.in](https://www.incometax.gov.in)
curl -I [https://www.onlinesbi.sbi](https://www.onlinesbi.sbi)
Test B: Restricted Web Traffic (Expected: Connection Timed Out / Dropped)
curl -I --connect-timeout 5 [https://www.facebook.com](https://www.facebook.com)
curl -I --connect-timeout 5 [https://www.gaming-site.com](https://www.gaming-site.com)
